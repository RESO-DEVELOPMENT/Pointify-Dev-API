...
namespace Infrastructure.Helper
{
    public static class AppConstant
    {
        ...
        public class ErrMessage
        {
            ...
            public const string Invalid_Channel = "Đơn hàng không áp dụng tại channel này.";
            ...
            public const string Invalid_Voucher = "Voucher không tồn tại!";
            ...
            public const string Invalid_ProductCondition =
                "Điều kiện sản phẩm không hợp lệ, xin hãy kiểm tra lại điều kiện lúc tạo";

            public const string Invalid_ProductAction =
                "Hành động khuyến mãi không hợp lệ, xin hãy kiểm tra lại hành động lúc tạo";

            public const string Invalid_VoucherQuantity =
                "Khuyến mãi không có đủ số lượng Voucher yêu cầu, số lượng còn lại ";
            ...
            public const string No_Game_Campaign =
                "Hiện tại không có chương trình khuyến mãi dành cho game, bạn vui lòng quay lại lần sau nhé !";
            ...
            Expression<Func<T, bool>> expression2)
        {
            ...
            return Expression.Lambda<Func<T, bool>>(
                (Expression) Expression.OrElse(expression1.Body, (Expression) invocationExpression),
