...
{
    public partial class PromotionEngineProductionContext : DbContext
    {
        public PromotionEngineProductionContext()
        {
        }

        public PromotionEngineProductionContext(DbContextOptions<PromotionEngineProductionContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=120.72.85.82,9033;Database=PromotionEngineProduction;User Id=sa;Password=f0^wyhMfl*25;Encrypt=True;TrustServerCertificate=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VoucherWallet>(entity =>
            {
                ...
                entity.HasOne(d => d.Voucher)
                    ...
                    .HasConstraintName("FK_VoucherWallet_Voucher");
            });
